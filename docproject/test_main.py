...
def test_complete_todo():
    ...
    assert response.status_code == 200
    # After test_update_todo, item 2 has updated title and time_estimate
    expected_response = {"id": item_id, "title": "Build a Docker Image - Updated", "time_estimate": 45, "completed": True}
    assert response.json() == expected_response
